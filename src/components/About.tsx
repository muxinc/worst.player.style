...
const About = () => {
    return (
        <>
            <h2 id="about" className="text-4xl md:text-5xl mt-4 mb-6 font-vcr text-plum drop-shadow-[2px_2px_0_#F26222]">About</h2>
