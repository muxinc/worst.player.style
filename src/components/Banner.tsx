        ...
        `}
            ...
            <div className="w-full flex flex-col">
                ...
                <div className="h-8 w-full bg-[#F26222]">
                    <div className="animated-text-strip h-full">
                        <span className="marquee-reverse font-bold text-white font-vcr">BUILD THE WORST PLAYER EVER&nbsp;&nbsp;</span>
                        <span className="marquee-reverse font-bold text-white font-vcr">BUILD THE WORST PLAYER EVER&nbsp;&nbsp;</span>
                        <span className="marquee-reverse font-bold text-white font-vcr">BUILD THE WORST PLAYER EVER&nbsp;&nbsp;</span>
                        <span className="marquee-reverse font-bold text-white font-vcr">BUILD THE WORST PLAYER EVER&nbsp;&nbsp;</span>
                        <span className="marquee-reverse font-bold text-white font-vcr">BUILD THE WORST PLAYER EVER&nbsp;&nbsp;</span>
                ...
                <div className="h-8 w-full bg-[#EA3737]">
                    <div className="animated-text-strip h-full">
                        <span className="marquee font-bold text-white font-vcr">SUBMISSIONS DUE JUNE 15, 2025&nbsp;&nbsp;</span>
                        <span className="marquee font-bold text-white font-vcr">SUBMISSIONS DUE JUNE 15, 2025&nbsp;&nbsp;</span>
                        <span className="marquee font-bold text-white font-vcr">SUBMISSIONS DUE JUNE 15, 2025&nbsp;&nbsp;</span>
                        <span className="marquee font-bold text-white font-vcr">SUBMISSIONS DUE JUNE 15, 2025&nbsp;&nbsp;</span>
                        <span className="marquee font-bold text-white font-vcr">SUBMISSIONS DUE JUNE 15, 2025&nbsp;&nbsp;</span>
